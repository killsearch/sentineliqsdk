"""Minimal DNSdumpster analyzer example.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run DNSdumpster analyzer example")
    ...
    parser.add_argument(
        "--execute",
        action="store_true",
        help="Execute real HTTP calls to DNSdumpster.com",
    )
    parser.add_argument(
        "--include-dangerous",
        action="store_true",
